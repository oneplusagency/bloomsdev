...
" ?>
				...
				<div class="row" style="margin-top: 20px;">
					...
					<div class="col-md-8 col-12"  id="mitarbeiterSelectField"> 
						...
						<select name="mitarbeiter" id="salonMitarbeiterField" class="form-control rounded-0" required aria-required="true" autocomplete="off">
				...
				<div class="row exta-spec">
					...
					<div class="col-md-8 col-12"> 
						<div class="input-group-100 date">
							<input type="text" id="datepicker" name="date" readonly="readonly" class="date_picker form-control rounded-0" placeholder="Bitte Datum auswählen" required value="" />
				...
				<div class="row">
					...
					<div class="col-md-8 col-12"> 
						<div id="servicePackageContainer"> 
							<select name="servicePackage" id="servicePackageField" class="form-control" required aria-required="true" autocomplete="off">
								<option value="Bitte Dienstleistung auswählen" selected disabled>Bitte Dienstleistung auswählen</option>
							</select>
						</div>
