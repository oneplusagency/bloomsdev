<div class="row">
    <div class="col-md-12">
        ...
        <section id="kontakt-wraper" class="mb-4">
            ...
            <!-- Section heading-->
            <h2 class="h1-responsive font-weight-bold text-left my-4 pt-md-5 mt-2">Bewerbung als Auszubildender</h2>
            <!--Section description-->
                ...
                <div class="col-md-7 mb-md-0 mb-5 text-left">
                    ...
                    <form method="post" name="kontaktformularForm" id="kontaktformularForm" class=" hlo w-100 has-validator has-recaptcha-v3" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="md-form">
                                    <textarea maxlenght="500" id="bloom_kontakt_message" name="message" rows="4" class="form-control rounded-0 md-textarea" placeholder="Warum möchtest Du Friseur werden? *"
                                        required></textarea>
                                </div>
