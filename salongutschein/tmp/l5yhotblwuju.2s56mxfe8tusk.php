...
<head>
    ...
    <meta name="description"
        content="bloom's Friseur! Ihr Top Friseur für die besten Frisurentrends und den besten Haarschnitt.  Ihr Friseur für Langhaarfrisuren und Kurzhaarfrisuren. Friseurtermine online buchen!" />
    <meta name="keywords"
        content="Friseur, Mannheim, Ludwigshafen, Mainz, Wiesbaden, Speyer, Landau, Worms, Heidelberg, Mannheim-innenstadt, Wiesbaden-innenstadt, Mainz-innenstadt, Friseure, Frisuren, Frisurentrends, Langhaarfrisuren, Kurzhaarfrisuren, Frisur, Trend, Frisurentrend, Haarschnitt" />
...
<body class="wpsn-snappable <?= ($view) ?>-body <?= ($classfoot) ?>-nenka">
    ...
    <div class="cookie-hint-wrapper" data-cookie-show="false">
        <div class="cookies-content">
            <div class="cookie-text">
                <p>Diese Webseite erhebt Nutzungsdaten mittels Cookies. Weitere Informationen zu dieser
                    Datenverarbeitung und zu Ihrem Widerspruchsrecht gegen diese Verarbeitung, finden Sie <a
                        href="./datenschutz.html" target="_blank">hier</a>.</p>
            </div>
            <div class="cookie-button">
                <div class=" website accept-btn">
                    <a href="javascript:void(null)" class="btn position-relative btn-hotel">SCHLIEßEN</a>
                </div>
            </div>
    ...
    <div class="wrapper">
        <?php if ($view =='home_new.html' || $view =='gutscheine.html'): ?>
            <?php else: ?>
