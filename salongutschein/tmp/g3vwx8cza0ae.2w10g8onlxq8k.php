<!-- Modal -->
<div class="modal fade modal-salon-subpage" id="termineDataModal" tabindex="-1" role="dialog" aria-labelledby="stylistModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        ...
        <div class="modal-content emp-modal">
            ...
            <div class="modal-body text-center text-dark">
                ...
                <div class="at-row">
                    ...
                    <div class="full-col-img">
                        ...
                        <div class="modal-employee-containpic">
                            <!-- style="background-image: url('https://developservice.de/kunden/blooms/1plus/upload/employee_webimages/2/1011_behlul_osmic_2_1589964903.jpg');" -->
                ...
                <a class="mt-3 mb-3 termine-url btn btn-hotel" href="<?= ($BASE) ?>/akademie-buchung.html">Termin vereinbaren</a>


                <div class="yakcho-nema mt-2">
                    <a id="stylebook-modal" class="mt-0 stylebook-modal" href="javascript:void(0)"><strong>Stylebook anschauen</strong></a>
