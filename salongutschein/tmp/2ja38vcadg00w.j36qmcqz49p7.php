<div class="row">
    <div class="col-md-12">
        ...
        <section id="kontakt-wraper" class="mb-4">
            ...
            <!-- Section heading-->
            <h2 class="h1-responsive font-weight-bold text-left my-4 pt-md-5 mt-2">Bewerbung als Fachkraft</h2>
            <!--Section description-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="md-form mb-0">
                                    ...
                                    <input type="text" name="alter" id="alter" placeholder="Alter *" class="form-control rounded-0 input-lg required" required="required"
                            ...
                            <div class="col-md-12">
                                <div class="md-form mb-0">
                                    <!-- <label for="jform_email" class="">E-Mail *</label> -->
                                    <input type="text" name="Wahtsapp" id="Wahtsapp" placeholder="WhatsAPP" class="form-control rounded-0 input-lg required" maxlenght="50" autocomplete="on" aria-required="true" aria-invalid="false" />
                                </div>
                            </div>
                            <!-- Grid column -->
