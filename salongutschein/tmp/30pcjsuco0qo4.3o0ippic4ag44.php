    ...
    <div class="col-md-8 offset-md-2 col-12 pt-3">
        ...
        <div class="row mt-5 mb-5">
            <div class="col-lg-6 col-12 ">
                <a href="<?= ($BASE) ?>/json/pdf/print" target="_blank" class="btn form-control px-2 mt-4"><i class="fa fa-clipboard"></i>
                        Termin drucken</a>
                <a href="<?= ($BASE) ?>/json/pdf/download" class="btn form-control px-2 mt-3"><i class="fa fa-file-pdf-o"></i> Termin als PDF speichern</a>
                <a href="<?= ($BASE) ?>/json/icalendar" class="btn form-control px-2  mt-3"><i class="fa fa-file-pdf-o"></i> Termin in Kalender eintragen</a>
