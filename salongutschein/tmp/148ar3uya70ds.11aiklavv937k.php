...
<center><p style="font-size:14px!important" ><strong>Zur verbindlichen Buchung erhalten Sie einen SMS Code auf Ihr Handy.</strong> (Versand nur innerhalb Deutschlands).</p></center>
            ...
            <div class="col-lg-4 col-12 mt-md-0 mt-2 d-none">
                <div class="row">
...
<div class="row">
    ...
    <form action="<?= ($BASE) ?>/akademie-buchung.html" id="form_appointment_id" class="back_form" style="display:none;" method="post">
