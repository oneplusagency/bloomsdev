                ...
                <div class="col-lg-8 col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10 text-wowann">
                            ...
                            <p id="ConfirmWann"> <span id="ConfirmTerminDate"></span> um <span id="ConfirmTerminTime"></span> Uhr</p>
                        </div>
                    </div>
                    <!-- row -->
                    <div class="row">
                        ...
                        <div class="col-10 text-wowann">
                            <!-- Finish Langhaar -->
                            <p id="dienstleistungDisplayName"><span id="ConfirmTerminServiseName"></span> <span id="s2tooltip" data-toggle="tooltip"  class="fa fa-info-circle"  data-placement="top" title=""></span>
                            </p>
                        </div>
                    </div>
                    <!-- row -->
                    <div class="row mt-4">
                        <div class="termine-data-radio-box col-12">
                            ...
                            <input type="radio" name="vertretung" id="terminradio1" class="radio-btn" value="true" checked />
