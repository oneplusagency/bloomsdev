...
<?php if ($view=='akademie-buchung.html' || $view=='akademie.html'): ?>
...
<?php if ($view=='akademie-buchung.html' || $view=='akademie.html'): ?>
        ...
        <script type="text/javascript" charset="utf-8">
            ...
            $.totalStorage(salon_field_id, 31);
            ...
            function getChangeServiseSelect(serviceId, servicePackageField, salonId) {
                ...
                $.getJSON(url, {
                    ...
                    var groupName = '';
                    var groupPreviousName = '';
                    servicePackageField.append('<option value="" selected=>Bitte Dienstleistung auswählen</option>');
                    ...
                    if (data.length > 0) {
                        $.each(data, function (i, subsector) {
                            ...
                            $.each(subsector.services, function (j, option) {
                                ...
                                $option.appendTo(servicePackageField);
                            });
