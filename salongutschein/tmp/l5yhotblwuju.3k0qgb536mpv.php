                ...
                <div class="col-lg-8 col-12">
                    ...
                    <div class="row mt-5">
                        <div class="termine-data-radio-box col-12">
                            <p class="mb-0" style="    font-size: 14px;font-weight: unset;font-style: normal;">Bei
                                Ausfall des Mitarbeiters</p>
                            <input type="radio" name="vertretung" id="terminradio1" class="radio-btn" value="true"
                                checked />
                            <label class="text-wowann" for="terminradio1" style="font-size: 14px !important;">
                                Vertretung durch Kollegen</label>
                            <br />
                            <input type="radio" name="vertretung" id="terminradio2" class="radio-btn" value="false" />
                            <label class="text-wowann" for="terminradio2" style="font-size: 14px !important;">Neuen
                                Termin vereinbaren</label>
                        </div>
                    </div>
                </div>
