        ...
        <article id="page-akademia" class="container p-md-0 mt-5">
            <section class="layout-akademia">
                <div class="image-akademia text-center">
                    ...
                    <p class="layout-akademia-info-text mx-auto mt-5">Die bloom´s Akademie im Herzen Mannheims steht für beste Weiterbildung.</p>
                ...
                <section class="layout-akademia-info-team mt-5" id="selection-tabs">
                    ...
                    <div class="text-center">
                        <button class="btn btn-page-bloom text-uppercase btn-active" onclick="showData(this,'#seminare-data');">SEMINARE
                        </button>
                        <button class="btn btn-page-bloom text-uppercase" onclick="showData(this,'#clip-data');" style="display:none;">
                            CLIPS
                        </button>
                        <button class="btn btn-page-bloom text-uppercase" onclick="showData(this,'#bilder-data');">BILDER
                        </button>
