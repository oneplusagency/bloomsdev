            ...
            <div class="row mt-6 card-stats">
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-secondary border-dark bg-dark mt-3 shadow text-center">
                        ...
                        <div class="card-body">
                            <p class="py-0  mb-0 text-muted text-sm"><a class="btn btn-outline-success"
                                    href="<?= ($BASE) ?>/admin/banner">&raquo; Banner bearbeiten</a></p>
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-secondary border-dark bg-dark mt-3 shadow text-center">
                        <div class="card-title card-title text-muted my-2">
                            <h5 class="card-title text-center"><i class="fa fas fa-image"></i> Banner Manager Preise
                            </h5>

                        </div>
                        <div class="card-body">
                            <p class="py-0  mb-0 text-muted text-sm"><a class="btn btn-outline-success"
                                    href="<?= ($BASE) ?>/admin/bannerprice">&raquo; Banner bearbeiten</a></p>
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-secondary border-dark bg-dark mt-3 shadow text-center">
                        <div class="card-title card-title text-muted my-2">
                            <h5 class="card-title text-center"><i class="fa fas fa-image"></i> Banner Manager Salons
                            </h5>

                        </div>
                        <div class="card-body">
                            <p class="py-0  mb-0 text-muted text-sm"><a class="btn btn-outline-success"
                                    href="<?= ($BASE) ?>/admin/bannersalons">&raquo; Banner bearbeiten</a></p>
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-secondary border-dark bg-dark mt-3 shadow text-center">
                        <div class="card-title card-title text-muted my-2">
                            <h5 class="card-title text-center"><i class="fa fas fa-image"></i> Banner Manager Akademie
                            </h5>

                        </div>
                        <div class="card-body">
                            <p class="py-0  mb-0 text-muted text-sm"><a class="btn btn-outline-success"
                                    href="<?= ($BASE) ?>/admin/bannerakademie">&raquo; Banner bearbeiten</a></p>
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-secondary border-dark bg-dark mt-3 shadow text-center">
                        <div class="card-title card-title text-muted my-2">
                            <h5 class="card-title text-center"><i class="fa fas fa-image"></i> Banner Manager Azubi
                            </h5>

                        </div>
                        <div class="card-body">
                            <p class="py-0  mb-0 text-muted text-sm"><a class="btn btn-outline-success"
                                    href="<?= ($BASE) ?>/admin/bannerbewerbung">&raquo; Banner bearbeiten</a></p>
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-secondary border-dark bg-dark mt-3 shadow text-center">
                        <div class="card-title card-title text-muted my-2">
                            <h5 class="card-title text-center"><i class="fa fas fa-image"></i> Banner Manager Fachkraft
                            </h5>

                        </div>
                        <div class="card-body">
                            <p class="py-0  mb-0 text-muted text-sm"><a class="btn btn-outline-success"
                                    href="<?= ($BASE) ?>/admin/bannerfachkraft">&raquo; Banner bearbeiten</a></p>
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-secondary border-dark bg-dark mt-3 shadow text-center">
                        <div class="card-title card-title text-muted my-2">
                            <h5 class="card-title text-center"><i class="fa fas fa-image"></i> Banner Manager Blooms
                            </h5>

                        </div>
                        <div class="card-body">
                            <p class="py-0  mb-0 text-muted text-sm"><a class="btn btn-outline-success"
                                    href="<?= ($BASE) ?>/admin/bannerblooms">&raquo; Banner bearbeiten</a></p>
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-secondary border-dark bg-dark mt-3 shadow text-center">
                        <div class="card-title card-title text-muted my-2">
                            <h5 class="card-title text-center"><i class="fa fas fa-image"></i> Banner Manager Kontakt
                            </h5>

                        </div>
                        <div class="card-body">
                            <p class="py-0  mb-0 text-muted text-sm"><a class="btn btn-outline-success"
                                    href="<?= ($BASE) ?>/admin/bannerkontakt">&raquo; Banner bearbeiten</a></p>
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-secondary border-dark bg-dark mt-3 shadow text-center">
                        ...
                        <div class="card-body">
                            <p class="py-0  mb-0 text-muted text-sm"><a class="btn btn-outline-success"
                                    href="<?= ($BASE) ?>/admin/settings/config">&raquo; Einstellungen
                                    bearbeiten</a></p>
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-secondary border-dark bg-dark mt-3 shadow text-center">
                        <div class="card-title card-title text-muted my-2">
                            <h5 class="card-title text-center"><i class="fa fas fa-book"></i>Preis Manager</h5>
                        </div>
                        <div class="card-body">
                            <p class="py-0  mb-0 text-muted text-sm"><a class="btn btn-outline-success"
                                    href="<?= ($BASE) ?>/admin/bannerpricenew">&raquo; Preise verwalten</a></p>
                    ...
                    <div class="card text-white bg-secondary border-dark bg-dark mt-3 shadow">
                        <div class="card-title card-title text-muted my-2">
                            ...
                            <div class="alert alert-warning" role="alert">
                                <p>Bitte Navigieren Sie nicht zu einer anderen Seite, es sei denn, es wird eine
                                    Abschluss- oder Fehlermeldung angezeigt.</p>
                                <p>Bitte warten Sie diesen Vorgang dauert eine lange Zeit.</p>
                            </div>
                        </div>
                        <div class="card-body">
                            <p class="py-0  mb-0 text-muted text-sm"><a target="_blank" class="btn btn-outline-success"
                                    href="<?= ($BASE) ?>/stylebook/importStylebookimg">&raquo;
