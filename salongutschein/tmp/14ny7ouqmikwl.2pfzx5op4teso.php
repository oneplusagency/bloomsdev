...
<html class="no-js" lang="de">
  ...
  <head>
    ...
    <link
      rel="stylesheet"
      href="<?= ($ASSETS) ?>css/style.css?<?= ($BLOOMS_VERSION) ?>"
    />
    ...
    <div class="cookie-hint-wrapper" data-cookie-show="false">
      <div class="cookies-content">
        <div class="cookie-text">
          <p>
            Diese Webseite erhebt Nutzungsdaten mittels Cookies. Weitere
            Informationen zu dieser Datenverarbeitung und zu Ihrem
            Widerspruchsrecht gegen diese Verarbeitung, finden Sie
            <a href="./datenschutz.html" target="_blank">hier</a>.
          </p>
        </div>
        <div class="cookie-button">
          <div class="website accept-btn">
            <a
              ...
              class="btn position-relative btn-hotel"
              >SCHLIEßEN</a
            >
          </div>
        </div>
