<div class="row">
    <div class="col-md-12">
        ...
        <article id="page-preise" class="container p-md-0 px-2">
            <section class="layout-preise">
                ...
                <section class="layout-preise-select-salon mx-auto">
                    ...
                    <div class="cancelationDaysRow layout-preise-select-salon-info mt-5" id="salon-info">
                        ...
                        <div id="price-table" class="table-responsive">
                            <div id="price-table" class="table-responsive">
...
" ?>
                                                    ...
                                                    <td class="td-gold groshi-price"><?= ($item['price']) ?> <span
                        ...
                        <div class="text-center mt-3">
                            <a class="btn position-relative btn-hotel" id="termin-link"
                                href="<?= ($BASE) ?>/termine.html"><strong>Termin vereinbaren</strong></a>
                        </div>
                    </div>
                </section>
