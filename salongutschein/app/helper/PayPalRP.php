...
class PayPalRP extends PayPal
{
     ...
     * @return array
     */
    public function setupRP( $description, $additional = null )
    {
        $nvp                                   = array();
     ...
     * @param  $additional array
     */
    public function setRPDetails( $amt, $startdate, $period, $frequency, $currency, $additional = null )
    {
     ...
     * @return array
     */
    public function createRP( $token )
    {
