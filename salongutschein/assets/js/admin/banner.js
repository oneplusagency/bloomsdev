(function($) {
    ...
    function saveOrderbanner_field() {
        ...
        //$("#listhaoSortOrder").text(data.join("|"));
        //$.post("fotoalbum.php", { "ids": data });
        $.ajax({
            url: BloombaseUrl + '/bannerAdmin/setPosition',
            type: "post",
            data: {
                "ids": data
            },
    ...
    function interval_field() {
        ...
        // $(".txtedit", conttable).mouseup(function() {
        //     // alert('opo')
        //     return false
        // });

        // Save data mouseup blur mousedown  mouseout focusout change blur
        // https://jsfiddle.net/zer00ne/f0xumv7L/
        // https://stackoverflow.com/questions/52570436/jquery-live-edit-table-do-ajax-update-and-delete-focusout-problem
        // conttable.on("focusout change blur", ".txtedit", function() {
        conttable.on("click", ".updatebutton", function() {
            ...
            if (value > 0) {
                ...
                $.ajax({
                    url: BloombaseUrl + '/bannerAdmin/interval',
                    type: "post",
    ...
    $(document).ready(function() {
        ...
        function fetch_banner_data() {
            var action = "fetch";
            $.ajax({
                url: BloombaseUrl + '/bannerAdmin/banner',
                method: "POST",
                data: { action: action },
                success: function(data) {
