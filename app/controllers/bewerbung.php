...
class bewerbung extends Controller
{
    ...
    private function banners()
    {
        ...
        $bannerAdmin = new bannerBewerbungAdmin();
	...
	public function index()
	{
		...
		$this->f3->set('title', "Bewerbung");
		$this->f3->set('view', 'bewerbung.html');
		$this->f3->set('classfoot', 'bewerbung');
        // ADD JS
        $addscripts = 'js/layout/bewerbung.js';
