...
(function($) {
    ...
    // const new_zapomyatav = $.totalStorage;
    ...
    $.fn.FormCache = function(options) {
        ...
        var form = $(this),
            zap_key = $(this).attr('id') + '_saveStorage',
            nonSavingInp = '';
...
/**
 * @Author: oppo  @Date: 2020-05-21 15:44:36
 * @Desc:  img preview
 */
! function(a) {
    "use strict";
    a.fn.anarchytip = function(b) {
        ...
        return this.each(function() {
            ...
            b.hover(function(b) {
                        ...
                        // $(tt).css('left', e.pageX);
                        // https://stackoverflow.com/questions/28391000/position-tooltip-above-mouse-when-room-in-viewport-otherwise-below-mouse

                        a("body").append("<p id='preview'><img src='" + this.src + "' alt='Image preview' />" + d + "</p>"),
                            a("#preview").css({ top: b.pageY - inView, left: b.pageX + c.yOffset + "px" }).fadeIn()
                    },

                    function() { this.title = this.t, a("#preview").remove() }
                ),
                b.mousemove(
                    function(b) {
                        // $(tt).css('top', e.pageY - $(tt).css('height'));
                        var move_height = a("#preview").css('height');
                        a("#preview").css("top", b.pageY - move_height).css("left", b.pageX + c.yOffset + "px")
                    }
                )
        })
    }
...
// 19.08.2020 19:35  FIX Remove mouseover for large viewing
...
//     if (windowWidth >= 960) {
//         jQuery('.img-hover-animation').anarchytip();
//     }
